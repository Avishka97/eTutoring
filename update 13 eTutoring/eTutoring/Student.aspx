        ...
        <div class="container" >
            ...
            <tbody>
              <tr>
                ...
                <tr>
                <td><asp:Label ID="lbl7days" runat="server" Text="Number of messages in last 7 days : 0" class="form-control"></asp:Label> </td>
                <td><asp:Label ID="lblavgmessage" runat="server" Text="Average number of messages for each personal tutor : 0" class="form-control"></asp:Label> </td>
              </tr>
            </tbody>
          </table>
